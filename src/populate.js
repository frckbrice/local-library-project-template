...
async function authorCreate(index, first_name, family_name, d_birth, d_death) {
  ...
  await author.save();
  console.log(author);
  // await Author.create(authordetail);
...
async function createAuthors() {
  ...
  await Promise.all([
    ...
    authorCreate(1, "Ben", "Bova", "1971-12-16", "2000-12-16"),
    authorCreate(2, "Isaac", "Asimov", "1920-01-02", "1992-04-06"),
    authorCreate(3, "Bob", "Billings", "1871-12-16", "1971-12-16"),
    authorCreate(4, "Jim", "Jones", "1971-12-16", "2020-12-16"),
  ]);
}
